...
| 3 | [Unified `assess`](03-unified-assess.md) | Run authorized DAST, SAST, infrastructure, and cloud families together |
| 4 | [Agent workflow](04-agent-workflow.md) | Use Codex or another agent without giving it authority outside ScorchKit |
...
- Tutorials describe ScorchKit 3.0. Earlier versions may diverge.
