...
//! Kubernetes context. It's carried on both [`crate::AppConfig`]
//! (read at startup, env-merged) and on
//! the cloud context's credential field (for cloud-family modules).
//!
...
//!   treated as "unset" — matches the [`crate::network_credentials`]
